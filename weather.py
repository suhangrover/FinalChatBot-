...
client = AI21Client(api_key="YOUR_API_KEY")  # Replace with your actual API key
...
roles = {
    "general": "You are a helpful assistant for general inquiries.",
    "forecaster": "You are a weather forecaster providing current weather conditions and forecasts.",
}
...
def get_bot_response():
    ...
    # Handle general conversation if current role is general
    if current_role == roles["general"]:
...
role_dropdown = ttk.OptionMenu(root, role_var, "general", "general", "forecaster", command=set_role)
